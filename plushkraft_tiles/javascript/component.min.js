...
this.codeBox.find(".qrcode").css({"background-color":this.mainColor,color:this.fontColor});this.codeBox.find(".miniProgram").css({"background-color":this.mainColor,color:this.fontColor});this.copy1.css({"background-color":this.mainColor,color:this.fontColor})},initHtml:function(){var a=this;this.titleContainer=$("<div class='title_content'></div>");this.titleContainer.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.titleContainer.append(this.close);
this.stage.append(this.titleContainer);this.content=$("<div class='share_content'></div>");this.initSwiper();this.stage.append(this.content);this.shareCurrentPageBox.append(this.shareCurrentCheck).append(this.shareCurrentPageTitle1);this.getQrCodeStatus().then(function(b){b&&a.content.append(a.codeBox)}).catch(function(b){console.error("Error getting QR code status:",b)});this.swiperContainer.append(this.sharePanelTitle);this.content.append(this.swiperContainer);this.linkBox.append(this.linkArea).append(this.copy1);
this.content.append(this.shareCurrentPageBox);this.content.append(this.linkBox);this._super()},changeItemColor:function(){this.elements.fontColor=this.mainColor;this.shareCurrentCheck.changeButtonColor(this.mainColor)},onShow:function(){var a=this;this.close.changeButtonColor(this.fontColor);this.changeItemColor();this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.shareStage.refreshData();this.elements.addItem(function(b){a.stage[0].style.display="inline-block";if(b){var c;null==(c=
