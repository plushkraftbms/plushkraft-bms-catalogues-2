...
h);d+=g}function c(){d+=k;0<e?(l.css({left:d+"px",top:m+"px",display:"block"}),d+=e):l.css({display:"none"});d+=k}var d=a,e=this.edtNumber.width,f=this.container.body;d=a;var g=this.buttonWidth,h=this.buttonTop,l=this.edtNumber.body,m=this.edtNumber.top,k=this.edtNumber.space;rightToLeft?(bookConfig.enablePageBack&&b(this.btnForward),b(this.btnLast),b(this.btnNext),c(),b(this.btnPrevious),b(this.btnFirst),bookConfig.enablePageBack&&b(this.btnBackward)):(bookConfig.enablePageBack&&b(this.btnBackward),
